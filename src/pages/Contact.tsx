                    ...
                    <div className="space-y-6">
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          ...
                          <a href="mailto:contact@canaanculturemedia.com" className="text-accent hover:text-accent-hover">
                            contact@canaanculturemedia.com
                          </a>
                        </div>
                      </div>
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          ...
                          <a href="tel:+12345678901" className="text-accent hover:text-accent-hover">
                            +1 (234) 567-8901
                          </a>
                        </div>
                      </div>
